                ...
                <div class="row">      
                    ...
                    <div class="navbar-header col-xs-12 col-sm-8 col-sm-offset-1  col-lg-8 col-md-8">
                        ...
                        <!-- <form class="navbar-form   hidden-xs" role="search" action="ActionServlet" method="GET">
                             ...
                             <button class="btn mybtn-primary height-40" type="submit">Search</button>
                             </span>
                             <div>
                             </form>-->
            ...
            <div class="collapse navbar-collapse hidden-lg" id="search">
                <form class="mobile_search hidden-sm hidden-md hidden-lg" role="search" action="/" method="GET">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <a href="ActionServlet?op=getList" class="btn mybtn-primary" type="button">Search</a>
                        </span>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                <div id="orderByDiv" class="pull-right">
                                    <label for="sel1" class="mylabel"> <fmt:message key="orderButton" /> </label> <select id="sel1" class="myselect mybtn-primary"
                                        ...
                                        <option id="ordNome" class="myoption" value="ActionServlet?op=getList&filtro=<%=filter%>&search=<%=key%>&tag=<%=tag%>&orderBy=nome">  
                                            <fmt:message key="ordName"/>  </option> 
                                        <option id="ordUsiMax" class="myoption" value="ActionServlet?op=getList&filtro=<%=filter%>&search=<%=key%>&tag=<%=tag%>&orderBy=utilizziMax"> 
                                            <fmt:message key="ordUsiMax"/> </option>
                                        <option id="ordUsiMin" class="myoption" value="ActionServlet?op=getList&filtro=<%=filter%>&search=<%=key%>&tag=<%=tag%>&orderBy=utilizziMin">   
                                            <fmt:message key="ordUsiMin"/> </option>
                                        <option id="ordRatMax" class="myoption" value="ActionServlet?op=getList&filtro=<%=filter%>&search=<%=key%>&tag=<%=tag%>&orderBy=votoMax">   
                                            <fmt:message key="ordRatMax"/></option>
                                        <option id="ordRatMin" class="myoption" value="ActionServlet?op=getList&filtro=<%=filter%>&search=<%=key%>&tag=<%=tag%>&orderBy=votoMin">  
